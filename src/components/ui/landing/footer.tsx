    ...
    return <>
        ...
        <footer className="w-full max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
            ...
            <div className="text-center">
                ...
                <div className="mt-3">
                    {/*<p className="text-gray-500 dark:text-neutral-500">Build for Developers<a className="text-blue-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium dark:text-blue-500" href="https://aures.dev/" target='blank'>Powered by AI</a>.</p>*/}
