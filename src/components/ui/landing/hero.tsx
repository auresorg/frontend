        ...
        <div className="relative overflow-hidden">
            <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10">
                <div className="max-w-2xl text-center mx-auto">
                    <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl md:text-5xl dark:text-white">Your Work. Your Profile. <br />One <span className="text-blue-600">Identity.</span></h1>
                    <p className="mt-3 text-lg text-gray-800 dark:text-neutral-400">
                        Become the 10x developer and stand out among the top 1%</p>
                </div>
