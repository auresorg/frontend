...
export default function NotificationBar() {
    ...
    return (
        <Card className="w-full relative overflow-hidden bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 shadow-sm p-0!">
            <div className="relative flex w-full items-center min-h-[80px] px-14 py-4">
                ...
                <div 
                    key={currentNotif.id} 
                    className="flex-1 flex items-center gap-4 overflow-hidden animate-in fade-in duration-500"
                >
                ...
                {hasMultiple && (
                    <button 
                        ...
                        disabled={!canGoNext}
                        className={cx(
                            "absolute right-12 top-1/2 -translate-y-1/2 p-1.5 rounded-full transition-colors",
                            canGoNext 
                                ? "text-gray-500 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-zinc-800 cursor-pointer" 
                                : "text-transparent cursor-default pointer-events-none"
                        )}
                ...
                <button 
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 p-1.5 text-gray-400 hover:text-red-500 dark:hover:text-red-400 transition-colors rounded-full hover:bg-gray-100 dark:hover:bg-zinc-800"
